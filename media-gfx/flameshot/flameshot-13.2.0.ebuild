...
SRC_URI="https://github.com/flameshot-org/flameshot/archive/refs/tags/v13.2.0.tar.gz -> flameshot-v13.2.0.tar.gz"
...
FS_LINGUAS="
	ar bg ca cs da de_DE el en es et eu fa fi fr ga gl grc he hu id it_IT ja ka ko nb_NO nl nl_NL pl pt pt_BR ro ru sk sr_SP sv_SE sw ta th tr uk vi zh_CN zh_HK zh_TW
"
