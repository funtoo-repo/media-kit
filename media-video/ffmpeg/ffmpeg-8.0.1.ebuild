...
FFMPEG_FLAG_MAP=(
		...
		openssl samba:libsmbclient sdl:ffplay sdl:sdl2 vaapi vdpau vulkan
...
multilib_src_test() {
	LD_LIBRARY_PATH="${BUILD_DIR}/libswscale:${BUILD_DIR}/libswresample:${BUILD_DIR}/libavcodec:${BUILD_DIR}/libavdevice:${BUILD_DIR}/libavfilter:${BUILD_DIR}/libavformat:${BUILD_DIR}/libavutil:${BUILD_DIR}/libavresample" \
		emake V=1 fate
}